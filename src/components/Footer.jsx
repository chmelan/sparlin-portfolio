function Footer() {
  return (
    <footer className="text-white bg-rose-600">
      <div className="px-4 pt-32 pb-12 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <a
            className="inline-block py-3 px-12 mt-8 text-sm font-medium hover:text-red-500 hover:bg-white rounded-full border border-white/25"
            href=""
          >
            Get Started
          </a>
